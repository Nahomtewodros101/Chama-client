  ...
  return (
    <div className="bg-gradient-to-r from-blue-400 to-teal-500 p-6 rounded-lg shadow-md mb-4">
      <div className="tabs flex justify-between mb-4">
        <button 
          className={`tab ${activeTab === 'income' ? 'bg-white text-blue-500' : 'text-white'} p-2 rounded-md`} 
          onClick={() => setActiveTab('income')}
        >
          Income
        </button>
        <button 
          className={`tab ${activeTab === 'expense' ? 'bg-white text-blue-500' : 'text-white'} p-2 rounded-md`} 
